    ...
    <section id="accueil" className="hero">
      <div className="container hero-content">
        <div className="hero-text">
          ...
          <h1 className="hero-title">Laëtitia Borde</h1>
          <p className="hero-role">Développeuse Web Full Stack</p>
          ...
          <div className="hero-socials">
            <a href="https://github.com/Aruthla" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
